package test.com.wezside.utilities.date 
{
	...
	public class TestDateUtil 
	{
		...
		{
			index = dateUtil.calculateStartDayOfTheWeek( new Date( 1982, 3, 1, 17, 26, 13 ));		// April 24, 1982 = 4 ( Thursday )
			assertEquals( 4, index );
			index = dateUtil.calculateStartDayOfTheWeek( new Date( 2054, 5, 19, 17, 26, 13 ));		// June 19, 2054 = 1 ( Monday )
			assertEquals( 1, index );
			index = dateUtil.calculateStartDayOfTheWeek( new Date( 1783, 8, 18, 17, 26, 13 ));		// September 18, 1783 = 1 (Monday)
			assertEquals( 1, index );
